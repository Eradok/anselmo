...
/** @type {string} */
const CACHE_VERSION = '1780722010|585018178';
/** @type {string} */
const CACHE_PREFIX = 'anselmo.blog-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'anselmo.blog.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["anselmo.blog.html","anselmo.blog.js","anselmo.blog.offline.html","anselmo.blog.icon.png","anselmo.blog.apple-touch-icon.png","anselmo.blog.audio.worklet.js","anselmo.blog.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["anselmo.blog.wasm","anselmo.blog.pck"];
